...
Love goes from 2.5\% in 1990 to 1.6\% in 2022, anger falls from 17.3\% to 15.0\%, 
sadness rises from 19.6\% to 22.3\%, and fear rises from 1.3\% to 1.8\%.
...
The LLM agent and BERT emotion model has disagreed in 33 out of 50 songs.
The most disagreements arose from emotion joy, which Claude labeled
as sadness (10 times), or love (10 times). It seems like the BERT model
over-predicts joy. Third, we do not report any causal relationship 
